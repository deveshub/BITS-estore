...
import com.bits.estore.domain.enumeration.Size;
import com.bits.estore.repository.EntityManager;
import com.bits.estore.repository.ProductRepository;
import com.bits.estore.service.ProductService;
...
class ProductResourceIT {
    ...
    void getAllProducts() {
        ...
        webTestClient
            ...
            .jsonPath("$.[*].size")
            .value(hasItem(DEFAULT_SIZE.toString()))
    ...
    void getProduct() {
        ...
        webTestClient
            ...
            .jsonPath("$.size")
            .value(is(DEFAULT_SIZE.toString()))
            .jsonPath("$.imageContentType")
