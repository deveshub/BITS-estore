...
import com.bits.estore.service.mapper.UserMapper;
...
class UserResourceIT {
    ...
    public static void deleteEntities(EntityManager em) {
        try {
            em.deleteAll("bits_user_authority").block();
