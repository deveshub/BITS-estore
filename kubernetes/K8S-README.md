...
```
$ docker image tag estore bitsassignment2020/estore
$ docker push bitsassignment2020/estore
$ docker image tag invoice bitsassignment2020/invoice
$ docker push bitsassignment2020/invoice
$ docker image tag notification bitsassignment2020/notification
$ docker push bitsassignment2020/notification
```
...
```
$ kubectl get svc estore -n bits-k8s-ns
```
...
```
$ kubectl scale deployment <app-name> --replicas <replica-count> -n bits-k8s-ns
```
...
```
$ kubectl set image deployment/<app-name>-app <app-name>=<new-image>  -n bits-k8s-ns
```
...
```
$ kubectl expose service jhipster-registry --type=NodePort --name=exposed-registry -n bits-k8s-ns
```

and explore the details using

```
$ kubectl get svc exposed-registry -n bits-k8s-ns
```

For scaling the JHipster registry, use

```
$ kubectl scale statefulset jhipster-registry --replicas 3 -n bits-k8s-ns
```
