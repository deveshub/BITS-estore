...
import com.bits.estore.domain.enumeration.InvoiceStatus;
import com.bits.estore.domain.enumeration.PaymentMethod;
import com.bits.estore.repository.InvoiceRepository;
...
class InvoiceResourceIT {
    ...
    @Test
    @Transactional
    void checkProductOrderIdIsRequired() throws Exception {
        int databaseSizeBeforeTest = invoiceRepository.findAll().size();
        // set the field null
